...
#define _SizeBufCRSFrx          (CRSF_MAX_PACKET_LEN + 3)
...
typedef enum
{
    ...
    CRSF_ADDRESS_RADIO_TRANSMITTER1  = 0xEA,
    CRSF_ADDRESS_CRSF_RECEIVER1    = 0xEC,
    CRSF_ADDRESS_CRSF_TRANSMITTER1  = 0xEE,
...
typedef struct rcPacket_s
{
  crsf_header_t   header;
     uint8_t     RXbuf[CRSF_MAX_PACKET_LEN];
} PACKED rcPacket_t;
