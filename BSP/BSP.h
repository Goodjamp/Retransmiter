...
#define LSM303DLHC_I2C_GPIO_SCL_PIN        LL_GPIO_PIN_6
#define LSM303DLHC_I2C_GPIO_SDA_PIN        LL_GPIO_PIN_7
...
// LED INDICATION
#define LED_INTERNAL_PORT    GPIOC
#define LED_INTERNAL_PIN     LL_GPIO_PIN_13
#define LED_EXTERNAL_PORT    GPIOB
#define LED_EXTERNAL_PIN     LL_GPIO_PIN_3
